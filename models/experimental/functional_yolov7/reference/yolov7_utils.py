...
def download_yolov7_weights(weights_path):
    # URL for the YOLOv7 pre-trained weights
    weights_url = "https://github.com/WongKinYiu/yolov7/releases/download/v0.1/yolov7.pt"

    if not os.path.exists(weights_path):
        logger.info("Downloading YOLOv7 weights...")
        torch.hub.download_url_to_file(weights_url, weights_path)
        logger.info(f"YOLOv7 weights saved as {weights_path}")

    else:
        logger.info(f"Weights file already exists: {weights_path}")
