...
* | Function Argument | Description                                                          | Type     | Valid Range                                    | Required |
* |-------------------|----------------------------------------------------------------------|----------|------------------------------------------------|----------|
* | icb0              | The identifier of the circular buffer (CB) containing input operand  | uint32_t | 0 to 31                                        | True     |
* | ocb               | The identifier of the output circular buffer (CB)                    | uint32_t | 0 to 31                                        | True     |
*/
// clang-format on
ALWI void hw_start_init(uint32_t icb0, uint32_t ocb) {
    UNPACK((llk_unpack_AB_hw_configure_disaggregated<DST_ACCUM_MODE>(icb0, icb0)));

    MATH((llk_math_pack_sync_init<DST_ACCUM_MODE>()));
    MATH((llk_math_hw_configure_disaggregated<false /*untilize*/, false /*skip_inputs*/>(icb0, icb0)));
