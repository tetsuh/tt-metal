...
static const std::vector<DispatchKernelNode> galaxy_nine_chip_arch_1cq_fabric = {
    ...
    {8, 0, 0, 0, FABRIC_MUX, /*full size*/ {0, 2, 4, 6}, /*header only*/ {1, 3, 5, 7}, k_fabric_mux_noc},
    ...
    {17, 0, 1, 0, FABRIC_MUX, /*full size*/ {9, 11, 13, 15}, /*header only*/ {10, 12, 14, 16}, k_fabric_mux_noc},
    ...
    {21, 1, 0, 0, RETURN_FABRIC_MUX, /*full size*/ {19}, /*header only*/ {18}, k_fabric_mux_noc},
    ...
    {25, 2, 0, 0, RETURN_FABRIC_MUX, /*full size*/ {23}, /*header only*/ {22}, k_fabric_mux_noc},
    ...
    {29, 3, 0, 0, RETURN_FABRIC_MUX, /*full size*/ {27}, /*header only*/ {26}, k_fabric_mux_noc},
    ...
    {33, 4, 0, 0, RETURN_FABRIC_MUX, /*full size*/ {31}, /*header only*/ {30}, k_fabric_mux_noc},
    ...
    {37, 5, 0, 0, RETURN_FABRIC_MUX, /*full size*/ {35}, /*header only*/ {34}, k_fabric_mux_noc},
    ...
    {41, 6, 0, 0, RETURN_FABRIC_MUX, /*full size*/ {39}, /*header only*/ {38}, k_fabric_mux_noc},
    ...
    {45, 7, 0, 0, RETURN_FABRIC_MUX, /*full size*/ {43}, /*header only*/ {42}, k_fabric_mux_noc},
    ...
    {49, 8, 0, 0, RETURN_FABRIC_MUX, /*full size*/ {47}, /*header only*/ {46}, k_fabric_mux_noc},
};
...
static const std::vector<DispatchKernelNode> galaxy_nine_chip_arch_2cq_fabric = {
    ...
    {16, 0, 0, 0, FABRIC_MUX, /*full size*/ {0, 1, 4, 5, 8, 9, 12, 13}, /*header only*/ {2, 3, 6, 7, 10, 11, 14, 15}, k_fabric_mux_noc},
    ...
    {33, 0, 1, 0, FABRIC_MUX, /*full size*/ {17, 18, 21, 22, 25, 26, 29, 30}, /*header only*/ {19, 20, 23, 24, 27, 28, 31, 32}, k_fabric_mux_noc},
    ...
    {40, 1, 0, 0, RETURN_FABRIC_MUX, /*full size*/ {36, 37}, /*header only*/ {34, 35}, k_fabric_mux_noc},
    ...
    {47, 2, 0, 0, RETURN_FABRIC_MUX, /*full size*/ {43, 44}, /*header only*/ {41, 42}, k_fabric_mux_noc},
    ...
    {54, 3, 0, 0, RETURN_FABRIC_MUX, /*full size*/ {50, 51}, /*header only*/ {48, 49}, k_fabric_mux_noc},
    ...
    {61, 4, 0, 0, RETURN_FABRIC_MUX, /*full size*/ {57, 58}, /*header only*/ {55, 56}, k_fabric_mux_noc},
    ...
    {68, 5, 0, 0, RETURN_FABRIC_MUX, /*full size*/ {64, 65}, /*header only*/ {62, 63}, k_fabric_mux_noc},
    ...
    {75, 6, 0, 0, RETURN_FABRIC_MUX, /*full size*/ {71, 72}, /*header only*/ {69, 70}, k_fabric_mux_noc},
    ...
    {82, 7, 0, 0, RETURN_FABRIC_MUX, /*full size*/ {78, 79}, /*header only*/ {76, 77}, k_fabric_mux_noc},
    ...
    {89, 8, 0, 0, RETURN_FABRIC_MUX, /*full size*/ {85, 86}, /*header only*/ {83, 84}, k_fabric_mux_noc},
};
        ...
        if (tt::tt_metal::MetalContext::instance().get_cluster().is_galaxy_cluster()) {
            ...
            for (auto mmio_device_id : mmio_devices) {
                ...
                for (DispatchKernelNode node : *nodes_for_one_mmio) {
                    ...
                    // Exception for RETURN_FABRIC_MUX because servicing_device_id is being used as
                    // tunnel id
                    if (node.kernel_type != RETURN_FABRIC_MUX && node.kernel_type != FABRIC_MUX) {
