...
//             ccl_command_stream0.push_back(local_write_cb_to_tensor_slice(in0_command_tensor_slice,
//             cb_indices.at(0)));
//             ccl_command_stream1.push_back(local_write_cb_to_tensor_slice(in1_command_tensor_slice,
//             cb_indices.at(1)));
//         } else {
...
//         ccl_command_stream0,
//         ccl_command_stream1,
//         forward_device, // chip0_worker_forward_fabric_connection,
//         backward_device); // chip0_worker_backward_fabric_connection);
...
//                 devices.at(i), test_config.size_bytes, test_config.page_size_bytes,
//                 test_config.output_buffer_type}));
//         } else {
...
//         line_fabric.uniquely_connect_worker(devices[0], ttnn::ccl::LineDirection::FORWARD);
...
//             devices, subdevice_managers, line_fabric.value(),
...
//     const std::size_t edm_buffer_size =
//         tt::tt_fabric::FabricEriscDatamoverBuilder::default_packet_payload_size_bytes +
//         tt::tt_fabric::get_tt_fabric_packet_header_size_bytes();
...
inline bool TestMultiInputReaderKernel(
    ...
    auto launch_ccl_command_interpreter_workers = [&](std::vector<Program>& _programs) -> bool {
    ...
    //     // some get shutdown in between any packets in the pipeline. This can only be fixed by having a "drainer" op
    //     to
